...
parser.add_argument('--netd', default='dcgan32px',
                    help="path to netd config")
parser.add_argument('--netG_chp', default='./results_AEGAN_normal_256/netG_epoch_306.pth',
                    help="path to netG (to continue training)")
parser.add_argument('--netD_chp', default='./results_AEGAN_acai_sphere_256/netG_epoch_306.pth',
                    help="path to netD (to continue training)")
parser.add_argument('--netE_chp', default='./results_AEGAN_normal_256/netE_epoch_306.pth',
...
parser.add_argument('--netd_chp', default='./results_AEGAN_acai_sphere_256/netG_epoch_306.pth',
                    help="path to netd (to continue training)")
parser.add_argument('--save_dir', default='./results/results_ablation/normal256',
