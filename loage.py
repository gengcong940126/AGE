...
parser.add_argument('--nete_chp', default='',
                    help="path to netE (to continue training)")
parser.add_argument('--save_dir', default='./results_loage',
...
os.makedirs('./results_loage',exist_ok=True)
os.makedirs('./results_loage/tb',exist_ok=True)
...
def save_images(epoch):
    ...
    netG.eval()
    netg.eval()
    fake = netG(netg(fixed_z.squeeze()))
