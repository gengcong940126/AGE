...
class W_GAN_GP(GAN):
  ...
  def __init__(self, name, learning_rate, lam, n_output, noise_dim, discriminator, generator,
               beta=0.5, gen_kwargs={}, disc_kwargs={}, graph=None):
    ...
    with tf.variable_scope(name):
      ...
      with tf.variable_scope('discriminator') as scope:
        gradients = \
          tf.gradients(self.discriminator(interpolates, reuse=True, scope=scope, **disc_kwargs)[1], [interpolates])[0]
