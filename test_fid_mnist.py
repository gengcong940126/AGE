...
parser.add_argument('--dataroot', type=str, help='path to dataset',default='./data/raw')
...
parser.add_argument('--netd', default='dcgan32px',
                    help="path to netd config")
parser.add_argument('--netG_chp', default='./results_mnist/AEGAN_acai/netG_epoch.pth',
