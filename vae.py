...
parser.add_argument('--netd_chp', default='',
                    help="path to netd (to continue training)")
parser.add_argument('--save_dir', default='./results_celeba/vae_128',
...
os.makedirs('./results_celeba/vae_128',exist_ok=True)
os.makedirs('./results_celeba/vae_128/tb',exist_ok=True)
writer=SummaryWriter(log_dir='./results_celeba/vae_128/tb')
